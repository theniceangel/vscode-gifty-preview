import { autocomplete, getAlgoliaResults, AutocompleteComponents } from '@algolia/autocomplete-js'
...
//     '6PSZ2W2SFT',
//     '9b737e98f20d1c840436d3b21324d3da'
// )
...
const querySuggestionsPlugin = createQuerySuggestionsPlugin({
    ...
    getSearchParams({ state }) {
        // @ts-expect-error type error in recentSearchesPlugin
...
export default createAutocomplate
